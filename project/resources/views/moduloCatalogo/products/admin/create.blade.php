...
@section('content')
    ...
    <form method="POST" action="{{ route('storeProduct') }}" role="form" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select id="product_category_animals_id" name="product_category_animals_id" class="form-select @error('img_ref') is-invalid @enderror">
        ...
        <div class="mb-3">
            ...
            <select name="shop_id" class="form-control" class="form-select @error('img_ref') is-invalid @enderror" required>
