    ...
    <form method="POST" action="{{ route('adopciones.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                placeholder="Ingrese nombre" name="name" required value="{{ old('name') }}">
            @error('name')
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control @error('species') is-invalid @enderror" id="species"
                placeholder="Ingrese species" name="species" required value="{{ old('species') }}">
            @error('species')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('animal_race') is-invalid @enderror" id="animal_race"
                placeholder="Ingrese animal_race" name="animal_race" required value="{{ old('animal_race') }}">
            @error('animal_race')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('sex_animal') is-invalid @enderror" id="sex_animal"
                placeholder="Ingrese sex_animal" name="sex_animal" required value="{{ old('sex_animal') }}">
            @error('sex_animal')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('age_animal') is-invalid @enderror" id="age_animal"
                placeholder="Ingrese age_animal" name="age_animal" required value="{{ old('age_animal') }}">
            @error('age_animal')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('descriptions_animals') is-invalid @enderror"
                id="description_animals" placeholder="Ingrese descriptions_animals" name="description_animals" required
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control @error('photo_animal') is-invalid @enderror" id="photo_animal"
                placeholder="Ingrese photo_animal" name="photo_animal" required value="{{ old('photo_animal') }}">
            @error('photo_animal')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('location_address') is-invalid @enderror" id="location_address"
                placeholder="Ingrese locacion" name="location_address" required value="{{ old('location_address') }}">
