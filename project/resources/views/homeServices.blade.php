...
<body>
  ...
  ?>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ ($isAdmin) ? route('dogGroomerAdmin') : route('dogGroomerUser') }}">Peluqueria</a>
              </li>
            </ul>
    ...
    <h1>SERVICE HOME</h1>
    <p>Imagen central bonita o carrusel de imagenes</p>
      ...
      <div class="contenedor">
        ...
        <div class="cards">
          <div class="card">
            ...
            <div class="pservicio">Veterinario</div>
          </div>
          <div class="card">
