    ...
    <div class="contenedor">
        <section class="welcome">
            ...
            <div class="main-view">
                ...
                <h1 class="title-page">Bienvenido al módulo de servicios</h1>
                <div class="texto-bienvenida">
                    <p class="texto-principal">En este módulo de cuidados, se brinda una amplia gama de servicios para mascotas, que incluyen
