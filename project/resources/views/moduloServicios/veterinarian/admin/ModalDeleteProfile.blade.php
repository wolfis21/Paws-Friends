<div class="modal fade" id="deleteProfile{{$veterinarian->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="color: #000">
            ...
            <div class="modal-body">
                <p>Deseas eliminar a {{ $veterinarian->name }}</p>
            </div>
