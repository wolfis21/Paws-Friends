...
@section('title', 'Editar Status Demanda')
@section('content')
    <h1>Editar Status Demanda</h1>
    <form method="POST" action="{{ route('historial_admin.update',  $demand->id) }}"  role="form" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="hidden" id="description_case" name="users_id" value="{{ $demand->description_case }}"> 
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="motivo_id" name="motivo_id" value="{{ $demand->motivo->name}}" readonly>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="urgencia_id" name="urgencia_id" value="{{ $demand->urgencia->name}}" readonly>
